...
function AiTakeSection({ C, MONO, SANS }) {
  ...
  return (
    <div style={{ background: C.card, border: `1px solid ${C.accent}44`, borderRadius: 12, padding: "14px 16px", marginBottom: 18 }}>
      ...
      {state === "error" && <div style={{ fontFamily: MONO, fontSize: 12, color: C.red }}>Couldn't generate a take — check ANTHROPIC_API_KEY is set, and that the data above has loaded.</div>}
