...
export function computeEntryStage({ price, pivot, atr, breakoutConfirmed, extended, doNotChaseZone, priceAction, qualifying, zones, thresholds = {}, structureBroken, foundationVerdict }) {
